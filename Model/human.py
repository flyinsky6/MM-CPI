...
def load_compound_features():
    ecfp = torch.tensor(np.load('D:/研究生/加特征数据/human化合物四种特征完整版/ECFP完整.npy'), dtype=torch.float32)
    extfp = torch.tensor(np.load('D:/研究生/加特征数据/human化合物四种特征完整版/Extfp完整.npy'), dtype=torch.float32)
    maccs = torch.tensor(np.load('D:/研究生/加特征数据/human化合物四种特征完整版/MACCS完整.npy'), dtype=torch.float32)
    mol2vec = torch.tensor(np.load('D:/研究生/加特征数据/human化合物四种特征完整版/mol2vec完整.npy'), dtype=torch.float32)
...
def load_protein_features():
    aac = torch.tensor(pd.read_csv(
        'D:/研究生/加特征数据/human蛋白质三种特征完整版/human（AAC）完整.csv', header=None).values, dtype=torch.float32)
    ctdc = torch.tensor(pd.read_csv(
        'D:/研究生/加特征数据/human蛋白质三种特征完整版/human（CTDC）完整.csv', header=None).values, dtype=torch.float32)
    gaac = torch.tensor(pd.read_csv(
        'D:/研究生/加特征数据/human蛋白质三种特征完整版/human（GAAC）完整.csv', header=None).values, dtype=torch.float32)
...
# 加载数据
compounds, proteins, labels = load_human_dataset('/dataset/human.txt')
